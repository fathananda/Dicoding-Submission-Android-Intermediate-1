...
import com.example.middleprojectinter.databinding.ActivityAddStoryBinding
import com.example.middleprojectinter.utils.createCustomTempFile
import com.example.middleprojectinter.utils.rotateImage
import com.example.middleprojectinter.utils.uriToFile
    ...
    private fun uploadImage() {
        when {
            ...
            binding.edAddDescription.text.isNullOrBlank() -> {
                binding.edAddDescription.error = getString(R.string.empty_description)
    ...
    private fun startTakePhoto() {
        ...
        createCustomTempFile(application).also {
            val photoUri = FileProvider.getUriForFile(
                this@AddStoryActivity,
                "com.example.middleprojectinter",
                it
            )
