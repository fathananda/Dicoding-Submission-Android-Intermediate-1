...
import com.example.middleprojectinter.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun animatedPlay() {
        ...
        AnimatorSet().apply {
            playSequentially(labelAnimator,nameAnimator, loginAnimator, emailAnimator, passwordAnimator,registerAnimator)
            start()
        }
    }
